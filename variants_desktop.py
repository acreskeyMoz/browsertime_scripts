...
# variants = [('cira', 'desktop.sh', ' --firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://private.canadianshield.cira.ca/dns-query ' ),
#             ('cira_wait_off', 'desktop.sh', ' --firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://private.canadianshield.cira.ca/dns-query --firefox.preference:network_dns_wait_for_https_rr_with_trr:false --firefox.preference:network_dns_use_https_rr_as_altsvc:false ' ),
#             ('cloudflare', 'desktop.sh', '--firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://mozilla.cloudflare-dns.com/dns-query  ' ),
#             ('cloudflare_wait_off', 'desktop.sh', ' --firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://mozilla.cloudflare-dns.com/dns-query --firefox.preference:network_dns_wait_for_https_rr_with_trr:false --firefox.preference:network_dns_use_https_rr_as_altsvc:false ' ),
#             ('native', 'desktop.sh', ' --firefox.preference network.trr.mode:0 ' ),
#             ('cira_run2', 'desktop.sh', ' --firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://private.canadianshield.cira.ca/dns-query ' ),
#             ('cira_wait_off_run2', 'desktop.sh', ' --firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://private.canadianshield.cira.ca/dns-query --firefox.preference:network_dns_wait_for_https_rr_with_trr:false --firefox.preference:network_dns_use_https_rr_as_altsvc:false ' ),
#             ('cloudflare_run2', 'desktop.sh', '--firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://mozilla.cloudflare-dns.com/dns-query  ' ),
#             ('cloudflare_wait_off_run2', 'desktop.sh', ' --firefox.preference network.trr.mode:3 --firefox.preference network.trr.uri:https://mozilla.cloudflare-dns.com/dns-query --firefox.preference:network_dns_wait_for_https_rr_with_trr:false --firefox.preference:network_dns_use_https_rr_as_altsvc:false ' ),
#             ('native_run2', 'desktop.sh', ' --firefox.preference network.trr.mode:0 ' )]
